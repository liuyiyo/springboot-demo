...
public class AesEncodeUtil {
    ...
    //私钥
    private static final String AES_KEY="installer@2018qw";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
    ...
    public static void main(String[] args) throws Exception {
        String content = "ALTER TABLE sys_data_node_basic add connect int(1) COMMENT '是否连接平台迁移接口'";
        test(content);
    }
